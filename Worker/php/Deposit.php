...
<html>
    ...
    <body>
	<div class="Word"> Deposit
	</div>
	<div class="Border">
        <a href="WorkerHomePage.php"><img src="../img/WorkerLogo.png" id="logo"></a>
		</br></br></br>
		<form name="AccountDepositForm" action="" method="post">
		<div class="AccountNum">Account Number: </br>
		<input name ="AccountId" class="AccountNumId" id="AccountNumId" size="25">
    ...
    $(function() {
      ...
      $(".AccountNumId").autocomplete({
		...
		<input class="AmountId" name="AmountId" id="AmountId" size="25">
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if ($_POST)
	{
		...
		else header('Location: WorkerHomePage.php');
				exit();
