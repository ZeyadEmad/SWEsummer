...
--
-- Host: localhost
-- Generation Time: Dec 10, 2017 at 07:13 AM
...
--
ALTER TABLE `intrest`
  ADD CONSTRAINT `FK12` FOREIGN KEY (`AccountNo`) REFERENCES `bankaccounts` (`Accountnumber`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `Loans`
--
ALTER TABLE `Loans`
  ADD CONSTRAINT `FK10` FOREIGN KEY (`AccountNo`) REFERENCES `bankaccounts` (`Accountnumber`);
...
--
ALTER TABLE `TRANSACTIONS`
  ADD CONSTRAINT `FK13` FOREIGN KEY (`FromAccount`) REFERENCES `bankaccounts` (`Accountnumber`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK14` FOREIGN KEY (`ToAccount`) REFERENCES `bankaccounts` (`Accountnumber`) ON DELETE CASCADE ON UPDATE CASCADE,
